...
import static com.example.segun.bit_etherconverter.MainActivity.LOG_TAG;

/**
 * Created by Segun on 04-11-2017.
 */
...
public final class QueryUtils {
    ...
    public static List<Currencies> fetchCurrencyData(String requestUrl) {
        // Create URL object
        ...
        List<Currencies> currs = extractCurrencies(jsonResponse);

        // Return the {@link Event}
        return currs;
    }

    public static List<Currencies> extractCurrencies(String currsJSON) {
        ...
        List<Currencies> currs = new ArrayList<>();
        ...
        try {
            ...
            while (iter.hasNext()) {
                ...
                Currencies curr = new Currencies(key, btcvalue, ethvalue);
